...
foreach x in "1_CDKN1A" "2_TBC1D4" "3_LMNA" "5_CBS" "6_DUSP26" "7_RPGR" "8_HMOX1" "9_GLO1" "10_SOD3" ///
"11_TXNIP" "12_MAPK8IP1" "13_HMG20A" "14_CTBP2" "15_IGF2" "16_ILDR2" "17_SYT7" "18_SNAP25B" "19_ADRA2A" "20_ACVR1C" ///
"21_CHD9" "22_PLIN1" "24_SIRT1" "25_MSRA" "26_SLC2A2" "27_IAPP" "29_CNGA1" "30_FTO" ///
"31_GNAS" "32_NCAM1" "34_ZNF598" "36_PDIA3" "37_TUBG1" "38_ANAPC5" "39_SSR1" "40_ATP2A3" ///
"41_FGF19" "42_SCD" "43_RFX6" "45_FNDC5" "46_IRX3" "47_NOTCH2" "48_BCL11A" "49_LPL" ///
"51_PHLPP1" "52_SLC2A10" "53_PNPLA3" "54_IGF1" "56_MMP28" ///
"95_GCG" "96_GLP1R" "97_SLC5A2" {

** Examine the effect of CRISPR/Cas9-induced mutations in each gene adjusted for tank, batch (in residuals) and tod
...
preserve
regress `outcome' i.`z'_dich tod i.batch i.tank i.age
...
preserve
regress `outcome' i.`z'_dich tod i.batch i.tank i.age pos_bio i.batch_bio
parmest, format(estimate %8.6f min95 max95 %8.6f p %8.1e) saving ("RESULTS/ins_lfabp10a/`x'/`z'_dich_batch/`outcome'_est", replace)
use "RESULTS/ins_lfabp10a/`x'/`z'_dich_batch/`outcome'_est", clear
gen N=e(N)
save "RESULTS/ins_lfabp10a/`x'/`z'_dich_batch/`outcome'_est", replace
...
preserve
regress `outcome' i.`z'_dich tod i.batch i.tank i.age length
parmest, format(estimate %8.6f min95 max95 %8.6f p %8.1e) saving ("RESULTS/ins_lfabp10a/`x'/`z'_dich_batch/`outcome'_est", replace)
use "RESULTS/ins_lfabp10a/`x'/`z'_dich_batch/`outcome'_est", clear
gen N=e(N)
save "RESULTS/ins_lfabp10a/`x'/`z'_dich_batch/`outcome'_est", replace
...
preserve
regress `outcome' i.`z'_dich tod i.batch i.tank i.age LiverLipIntBG
parmest, format(estimate %8.6f min95 max95 %8.6f p %8.1e) saving ("RESULTS/ins_lfabp10a/`x'/`z'_dich_batch/`outcome'_est", replace)
use "RESULTS/ins_lfabp10a/`x'/`z'_dich_batch/`outcome'_est", clear
gen N=e(N)
save "RESULTS/ins_lfabp10a/`x'/`z'_dich_batch/`outcome'_est", replace
...
preserve
regress `outcome' i.`z'_dich tod i.batch i.tank i.age dorsal_tail
parmest, format(estimate %8.6f min95 max95 %8.6f p %8.1e) saving ("RESULTS/ins_lfabp10a/`x'/`z'_dich_batch/`outcome'_est", replace)
use "RESULTS/ins_lfabp10a/`x'/`z'_dich_batch/`outcome'_est", clear
gen N=e(N)
save "RESULTS/ins_lfabp10a/`x'/`z'_dich_batch/`outcome'_est", replace
...
preserve
capture nbreg `outcome' i.`z'_dich tod i.batch i.tank i.age, irr
parmest, format(estimate %8.6f min95 max95 %8.6f p %8.1e) saving ("RESULTS/ins_lfabp10a/`x'/`z'_dich_batch/`outcome'_est", replace)
use "RESULTS/ins_lfabp10a/`x'/`z'_dich_batch/`outcome'_est", clear
gen N=e(N)
save "RESULTS/ins_lfabp10a/`x'/`z'_dich_batch/`outcome'_est", replace
...
preserve
regress `outcome' i.`z'_dich tod i.batch i.tank i.age length dorsal_area
...
preserve
regress `outcome' i.`z'_dich tod i.batch i.tank i.age length dorsal_area pos_bio i.batch_bio
parmest, format(estimate %8.6f min95 max95 %8.6f p %8.1e) saving ("RESULTS/ins_lfabp10a/`x'/`z'_dich_size/`outcome'_est", replace)
use "RESULTS/ins_lfabp10a/`x'/`z'_dich_size/`outcome'_est", clear
gen N=e(N)
save "RESULTS/ins_lfabp10a/`x'/`z'_dich_size/`outcome'_est", replace
...
preserve
regress `outcome' i.`z'_dich tod i.batch i.tank i.age LiverLipIntBG length dorsal_area
parmest, format(estimate %8.6f min95 max95 %8.6f p %8.1e) saving ("RESULTS/ins_lfabp10a/`x'/`z'_dich_size/`outcome'_est", replace)
use "RESULTS/ins_lfabp10a/`x'/`z'_dich_size/`outcome'_est", clear
gen N=e(N)
save "RESULTS/ins_lfabp10a/`x'/`z'_dich_size/`outcome'_est", replace
...
preserve
regress `outcome' i.`z'_dich tod i.batch i.tank i.age dorsal_tail length dorsal_area
parmest, format(estimate %8.6f min95 max95 %8.6f p %8.1e) saving ("RESULTS/ins_lfabp10a/`x'/`z'_dich_size/`outcome'_est", replace)
use "RESULTS/ins_lfabp10a/`x'/`z'_dich_size/`outcome'_est", clear
gen N=e(N)
save "RESULTS/ins_lfabp10a/`x'/`z'_dich_size/`outcome'_est", replace
...
preserve
capture nbreg `outcome' i.`z'_dich tod i.batch i.tank i.age length dorsal_area, irr
parmest, format(estimate %8.6f min95 max95 %8.6f p %8.1e) saving ("RESULTS/ins_lfabp10a/`x'/`z'_dich_size/`outcome'_est", replace)
use "RESULTS/ins_lfabp10a/`x'/`z'_dich_size/`outcome'_est", clear
gen N=e(N)
save "RESULTS/ins_lfabp10a/`x'/`z'_dich_size/`outcome'_est", replace
