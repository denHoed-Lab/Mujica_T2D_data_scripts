set more off
clear
cd "C:\Users\endmu284\Documents\Size\Data\S027_LMNA\"
...
replace conditions = "lmna_crispants" if condition == 1
...
parmest, format(estimate %8.6f min95 max95 %8.6f p %8.1e) saving ("RESULTS\S027_LMNA`outcome'_est", replace)
use "RESULTS\S027_LMNA`outcome'_est", clear
gen N=e(N)
save "RESULTS\S027_LMNA`outcome'_est.dta", replace
restore
}
...
* now append
clear
save "RESULTS\S027_LMNA.dta", replace emptyok 

foreach file in intlength_est ///
intangle_est 
{

use "RESULTS\S027_LMNA`file'", clear
gen model="`file'"
append using "RESULTS\S027_LMNA.dta"
save "RESULTS\S027_LMNA.dta", replace
}
use "RESULTS\S027_LMNA.dta", clear
...
replace parm = "lmna_crispants" if parm == "1.condition"
...
save "RESULTS\S027_LMNA_results.dta", replace
outsheet using "RESULTS\S027_LMNA_results.txt", noquote replace
outsheet using "C:\Users\endmu284\Documents\Size\Data\RESULTS\S027_LMNA_results.txt", noquote replace
