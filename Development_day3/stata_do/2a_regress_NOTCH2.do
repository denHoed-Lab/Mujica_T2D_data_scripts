set more off
clear
cd "C:\Users\endmu284\Documents\Size\Data\S021_NOTCH2\"
...
replace conditions = "notch2_crispants" if condition == 1
...
parmest, format(estimate %8.6f min95 max95 %8.6f p %8.1e) saving ("RESULTS\S021_NOTCH2`outcome'_est", replace)
use "RESULTS\S021_NOTCH2`outcome'_est", clear
gen N=e(N)
save "RESULTS\S021_NOTCH2`outcome'_est.dta", replace
restore
}
...
* now append
clear
save "RESULTS\S021_NOTCH2.dta", replace emptyok 

foreach file in intlength_est  ///
intangle_est 
{

use "RESULTS\S021_NOTCH2`file'", clear
gen model="`file'"
append using "RESULTS\S021_NOTCH2.dta"
save "RESULTS\S021_NOTCH2.dta", replace
}
use "RESULTS\S021_NOTCH2.dta", clear
...
replace parm = "notch2_crispants" if parm == "1.condition"
...
save "RESULTS\S021_NOTCH2_results.dta", replace
outsheet using "RESULTS\S021_NOTCH2_results.txt", noquote replace
outsheet using "C:\Users\endmu284\Documents\Size\Data\RESULTS\S021_NOTCH2_results.txt", noquote replace
