set more off
clear
cd "C:\Users\endmu284\Documents\Size\Data\S020_IGF1\"
...
replace conditions = "igf1_crispants" if condition == 1
...
parmest, format(estimate %8.6f min95 max95 %8.6f p %8.1e) saving ("RESULTS\S020_IGF1`outcome'_est", replace)
use "RESULTS\S020_IGF1`outcome'_est", clear
gen N=e(N)
save "RESULTS\S020_IGF1`outcome'_est.dta", replace
restore
}
...
* now append
clear
save "RESULTS\S020_IGF1.dta", replace emptyok 

foreach file in intlength_est  ///
intangle_est 
{

use "RESULTS\S020_IGF1`file'", clear
gen model="`file'"
append using "RESULTS\S020_IGF1.dta"
save "RESULTS\S020_IGF1.dta", replace
}
use "RESULTS\S020_IGF1.dta", clear
...
replace parm = "igf1_crispants" if parm == "1.condition"
...
save "RESULTS\S020_IGF1_results.dta", replace
outsheet using "RESULTS\S020_IGF1_results.txt", noquote replace
outsheet using "C:\Users\endmu284\Documents\Size\Data\RESULTS\S020_IGF1_results.txt", noquote replace
