set more off
clear
cd "C:\Users\endmu284\Documents\Size\Data\S019_BCL11A\"
...
replace conditions = "bcl11a_crispants" if condition == 1
...
parmest, format(estimate %8.6f min95 max95 %8.6f p %8.1e) saving ("RESULTS\S019_BCL11A`outcome'_est", replace)
use "RESULTS\S019_BCL11A`outcome'_est", clear
gen N=e(N)
save "RESULTS\S019_BCL11A`outcome'_est.dta", replace
restore
}
...
* now append
clear
save "RESULTS\S019_BCL11A.dta", replace emptyok 

foreach file in intlength_est  ///
intangle_est 
{

use "RESULTS\S019_BCL11A`file'", clear
gen model="`file'"
append using "RESULTS\S019_BCL11A.dta"
save "RESULTS\S019_BCL11A.dta", replace
}
use "RESULTS\S019_BCL11A.dta", clear
...
replace parm = "bcl11a_crispants" if parm == "1.condition"
...
save "RESULTS\S019_BCL11A_results.dta", replace
outsheet using "RESULTS\S019_BCL11A_results.txt", noquote replace
outsheet using "C:\Users\endmu284\Documents\Size\Data\RESULTS\S019_BCL11A_results.txt", noquote replace
