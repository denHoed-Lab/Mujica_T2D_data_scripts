set more off
clear
cd "C:\Users\endmu284\Documents\Size\Data\S013_DUSP6\"
...
replace conditions = "dusp6_crispants" if condition == 1
...
parmest, format(estimate %8.6f min95 max95 %8.6f p %8.1e) saving ("RESULTS\S013_DUSP6`outcome'_est", replace)
use "RESULTS\S013_DUSP6`outcome'_est", clear
gen N=e(N)
save "RESULTS\S013_DUSP6`outcome'_est.dta", replace
restore
}
...
* now append
clear
save "RESULTS\S013_DUSP6.dta", replace emptyok 

foreach file in intlength_est intangle_est 
{

use "RESULTS\S013_DUSP6`file'", clear
gen model="`file'"
append using "RESULTS\S013_DUSP6.dta"
save "RESULTS\S013_DUSP6.dta", replace
}
use "RESULTS\S013_DUSP6.dta", clear
...
replace parm = "dusp6_crispants" if parm == "1.condition"
...
save "RESULTS\S013_DUSP6_results.dta", replace
outsheet using "RESULTS\S013_DUSP6_results.txt", noquote replace
outsheet using "C:\Users\endmu284\Documents\Size\Data\RESULTS\S013_DUSP6_results.txt", noquote replace
