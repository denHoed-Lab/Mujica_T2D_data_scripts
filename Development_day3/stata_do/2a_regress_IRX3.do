set more off
clear
cd "C:\Users\endmu284\Documents\Size\Data\S010_IRX3\"
...
replace conditions = "irx3_crispants" if condition == 1
...
parmest, format(estimate %8.6f min95 max95 %8.6f p %8.1e) saving ("RESULTS\S010_IRX3`outcome'_est", replace)
use "RESULTS\S010_IRX3`outcome'_est", clear
gen N=e(N)
save "RESULTS\S010_IRX3`outcome'_est.dta", replace
restore
}
...
* now append
clear
save "RESULTS\S010_IRX3.dta", replace emptyok 

foreach file in intlength_est  ///
intangle_est 
{

use "RESULTS\S010_IRX3`file'", clear
gen model="`file'"
append using "RESULTS\S010_IRX3.dta"
save "RESULTS\S010_IRX3.dta", replace
}
use "RESULTS\S010_IRX3.dta", clear
...
replace parm = "irx3_crispants" if parm == "1.condition"
...
save "RESULTS\S010_IRX3_results.dta", replace
outsheet using "RESULTS\S010_IRX3_results.txt", noquote replace
outsheet using "C:\Users\endmu284\Documents\Size\Data\RESULTS\S010_IRX3_results.txt", noquote replace
