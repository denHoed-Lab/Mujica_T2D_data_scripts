set more off
clear
cd "C:\Users\endmu284\Documents\Size\Data\S023_SLC5A2\"
...
replace conditions = "slc5a2_crispants" if condition == 1
...
parmest, format(estimate %8.6f min95 max95 %8.6f p %8.1e) saving ("RESULTS\S023_SLC5A2`outcome'_est", replace)
use "RESULTS\S023_SLC5A2`outcome'_est", clear
gen N=e(N)
save "RESULTS\S023_SLC5A2`outcome'_est.dta", replace
restore
}
...
* now append
clear
save "RESULTS\S023_SLC5A2.dta", replace emptyok 

foreach file in intlength_est  ///
intangle_est 
{

use "RESULTS\S023_SLC5A2`file'", clear
gen model="`file'"
append using "RESULTS\S023_SLC5A2.dta"
save "RESULTS\S023_SLC5A2.dta", replace
}
use "RESULTS\S023_SLC5A2.dta", clear
...
replace parm = "slc5a2_crispants" if parm == "1.condition"
...
save "RESULTS\S023_SLC5A2_results.dta", replace
outsheet using "RESULTS\S023_SLC5A2_results.txt", noquote replace
outsheet using "C:\Users\endmu284\Documents\Size\Data\RESULTS\S023_SLC5A2_results.txt", noquote replace
